...
<section id="resolution">
  <h2>Размытие реальности</h2>
  <p>
    В реальном мире числа — это не точки, а <strong>«облака»</strong>. Чтобы
    узнать друга в толпе, нам не нужны поры на его коже — достаточно силуэта.
    Точно так же для принятия решения нам часто нужен
    <strong>порядок числа</strong>, а не его точное значение.
  </p>
...
<section id="estimation">
  <h2>Метод «округление до удобного»</h2>
  <p>
    Заменяем «неудобные» числа на ближайшие «круглые» — и мгновенно получаем
    оценку. В нашей космической ситуации:
  </p>
...
<section id="precision">
  <h2>Весы точности</h2>
  <p>
    Чем больше знаков после запятой мы хотим получить, тем
    <strong>дольше</strong> считаем. Но нужна ли нам такая точность для принятия решения
...
<section id="fermi">
  <h2>Порядки величин</h2>
  <p>
    Самая опасная ошибка — <strong>ошибка порядка</strong>. Получить 45 вместо
    42 — не страшно. Получить 420 вместо 42 — катастрофа: мост рухнет, бюджет
    закончится.
  </p>
...
<section id="formal-concepts">
  <h2>От интуиции к математике</h2>
  ...
  <div class="grid">
    ...
    <div class="card">
      ...
      <p>
        Если вы измеряете комнату шагами, глупо писать ответ в миллиметрах.
...
<section id="budget">
  <h2>Мини-проект: бюджет вечеринки</h2>
  <p>
    Вечеринка на 20 человек. Оцените общий бюджет <strong>за 1 минуту</strong>,
    не используя калькулятор. Попадёте ли вы в диапазон ±10%?
  </p>
...
<style>
  ...
  @media (max-width: 1100px) {
    ...
    #crisis .panel .display {
      flex-direction: column;
    }

    #fermi .game .question .options {
      flex-direction: column;
    }

    #fermi .game .question .options .option-btn {
      width: 100%;
    }
  }
</style>
